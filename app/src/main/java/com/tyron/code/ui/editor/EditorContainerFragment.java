...
import com.tyron.code.util.Utils;
    ...
    mTabLayout.addOnTabSelectedListener(
        new TabLayout.OnTabSelectedListener() {
          ...
          public void onTabUnselected(TabLayout.Tab p1) {
            ...
            p1.getCustomView().setBackground(null);
            p1.getCustomView().setBackgroundTintList(null);
          }
          ...
          public void onTabReselected(TabLayout.Tab p1) {
            ...
            popup.show();
            p1.getCustomView().setBackgroundResource(R.drawable.shape_item_corners);
            p1.getCustomView().setBackgroundTintList(ColorStateList.valueOf(
                    Utils.getColorFromAttr(requireContext(), R.attr.colorSecondaryContainer)
            ));
          }
...
//        });
  ...
  private void updateTab(TabLayout.Tab tab, int pos) {
    ...
    tab.setCustomView(R.layout.item_project_file_tab);

    final ImageView tabIcon = tab.getCustomView().findViewById(R.id.tabIcon);
    final TextView tabName = tab.getCustomView().findViewById(R.id.tabName);
